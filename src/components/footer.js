			...
			<div className="footer-content">
				...
				<div className="footer-column footer-social">
					...
					<div className="footer-social-icons">
						<a href="https://facebook.com" className="footer-social-link cursor-target" aria-label="Facebook" target="_blank" rel="noreferrer">
						...
						<a href="https://instagram.com" className="footer-social-link cursor-target" aria-label="Instagram" target="_blank" rel="noreferrer">
							<svg className="footer-social-icon" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
						...
						<a href="https://youtube.com" className="footer-social-link cursor-target" aria-label="YouTube" target="_blank" rel="noreferrer">
							<svg className="footer-social-icon" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
