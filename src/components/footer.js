			...
			<div className="footer-content">
				...
				<div className="footer-column footer-social">
					...
					<div className="footer-social-icons">
						<a href="https://www.facebook.com/smknegeri7semarang/?locale=id_ID" className="footer-social-link cursor-target" aria-label="Facebook" target="_blank" rel="noreferrer">
						...
						<a href="https://www.instagram.com/bagasrizky.hss/" className="footer-social-link cursor-target" aria-label="Instagram" target="_blank" rel="noreferrer">
							<svg className="footer-social-icon" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
						...
						<a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=RDdQw4w9WgXcQ&start_radio=1" className="footer-social-link cursor-target" aria-label="YouTube" target="_blank" rel="noreferrer">
							<svg className="footer-social-icon" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
